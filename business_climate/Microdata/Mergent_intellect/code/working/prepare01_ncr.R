# Concatenate together files downloaded from Mergent Intellect for NCR
...
# working directory
path = "Microdata/Mergent_intellect/data/original/mergent_intellect_ncr/"
...
# save working data
savepath = "Microdata/Mergent_intellect/data/working/"
readr::write_csv(companies, xzfile(paste(savepath,"mi_ncr_companies_details.csv.xz"), compression = 9))
readr::write_csv(financial, xzfile(paste(savepath,"mi_ncr_financial_info.csv.xz"), compression = 9))
readr::write_csv(executive, xzfile(paste(savepath,"mi_ncr_executives.csv.xz"), compression = 9))
