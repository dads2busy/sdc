...
# write.csv(dmv_bg_2021_acccess_scores_substance, "dmv_cttrbg_samhsa_2021_acccess_scores_substance", row.names = FALSE )
readr::write_csv(dmv_bg_2021_acccess_scores_substance, xzfile("ncr_cttrbg_samhsa_2021_access_scores_substance.csv.xz", compression = 9))
