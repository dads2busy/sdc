...
# write.csv(va_bg_2021_access_scores_subs, "va_hdcttrbg_samhsa_2021_access_scores_substance", row.names = FALSE )
readr::write_csv(va_bg_2021_access_scores_subs, xzfile("va_hdcttrbgca_samhsa_2021_access_scores_substance.csv.xz", compression = 9))
...
sf::st_write(
  ...
  c("dc_health_behavior_diet", "va_hdcttrbg_samhsa_2021_access_scores_substance"),
