...
if __name__ == "__main__":
    ...
    report, inv_final_df = evaluate_folder(".")
    ...
    with open("./docs/distribution/geographies_report.html", "w") as f:
        f.write(t.substitute(time_checked=time_checked, report=report))
        
    # write inventory    
    inv_final_df.to_csv("./docs/distribution/geographies_metadata.csv.xz", index=False, compression='infer')
