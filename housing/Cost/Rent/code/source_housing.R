...
#Exercise at the tract level: housing and transportation


# Housing Cost 

#data fro HUD
housing_cost_va_updated <- read_excel("~/git/cost-living/data/Housing cost/data/Working/housing_weighted_rents/va_tr_hud_2022_housing_cost.xlsx") %>% select(-c(`...1`))
