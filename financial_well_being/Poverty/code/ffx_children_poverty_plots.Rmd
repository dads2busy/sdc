...
child_df[child_df$race == 'his', "race"] <- "Hispanic (All Races)"
...
tmap_save(file="../docs/figures/choropleths/children/poverty_count_differences.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_count_differences_compressed.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_count_differences_jenks.png")
...
tm_shape(df_maps) +
    tm_polygons(col = "diff_w_m_pct", 
                ...
                style = 'cont') +
    tm_facets(by = "race") +
    tm_layout(main.title = "Poverty Percentage Point Difference (Girls-Boys) - 2021")

tmap_save(file="../docs/figures/choropleths/children/poverty_pct_differences.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_pct_differences_compressed.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_pct_differences_jenks.png")
```
...
tmap_save(file="../docs/figures/choropleths/children/poverty_count.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_count_compressed.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_count_jenks.png")
```
...
tmap_save(file="../docs/figures/choropleths/children/poverty_pct.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_pct_compressed.png")
...
tmap_save(file="../docs/figures/choropleths/children/poverty_pct_jenks.png")
```
