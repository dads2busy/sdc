...
#data counties VA
food_cost_adj <- read_excel("~/git/cost-living/data/Food cost/data/Working/va_ct_usda_sep22_adjusted_low_cost_meal_plan_costs.xlsx")
#data USDA USA
usda_meal_plan_sep2022 <- read_csv("~/git/sdc.food_dev/Food Cost/data/working/usda_meal_plan_sep2022.csv", skip = 1)
...
#Estimation
#first parentesis (eg.(1+ 0.2) ) is a usda adjustment for scale: larger the hh, larger the food purchase discount, etc. or, less people, more expensive to buy


hh_config_all_poss <- q1_income_puma
#Q1
food_col_th<- hh_config_all_poss %>% mutate(food_cost_month =
                                              case_when(hh_size == 1 ~
                                                          (1+ 0.2)*(food_cost_general_adj_infl %>% select(adult) %>% pull())*adult  +
                                                          (1+ 0.2)*(food_cost_general_adj_infl %>% select(teenager) %>% pull())*teenager +
                                                          (1+ 0.2)*(food_cost_general_adj_infl %>% select(preschooler) %>% pull())*preschooler +
                                                          (1+ 0.2)*(food_cost_general_adj_infl %>% select(schooler) %>% pull())*schooler +
                                                          (1+ 0.2)*(food_cost_general_adj_infl %>% select(toddler) %>% pull())*toddler +
                                                          (1+ 0.2)*(food_cost_general_adj_infl %>% select(infant) %>% pull())*infant,
                                                        hh_size == 2 ~
                                                          (1+ 0.1)*(food_cost_general_adj_infl %>% select(adult) %>% pull())*adult  +
                                                          (1+ 0.1)*(food_cost_general_adj_infl %>% select(teenager) %>% pull())*teenager +
                                                          (1+ 0.1)*(food_cost_general_adj_infl %>% select(preschooler) %>% pull())*preschooler +
                                                          (1+ 0.1)*(food_cost_general_adj_infl %>% select(schooler) %>% pull())*schooler +
                                                          (1+ 0.1)*(food_cost_general_adj_infl %>% select(toddler) %>% pull())*toddler +
                                                          (1+ 0.1)*(food_cost_general_adj_infl %>% select(infant) %>% pull())*infant,
                                                        hh_size == 3 ~
                                                          (1+ 0.05)*(food_cost_general_adj_infl %>% select(adult) %>% pull())*adult  +
                                                          (1+ 0.05)*(food_cost_general_adj_infl %>% select(teenager) %>% pull())*teenager +
                                                          (1+ 0.05)*(food_cost_general_adj_infl %>% select(preschooler) %>% pull())*preschooler +
                                                          (1+ 0.05)*(food_cost_general_adj_infl %>% select(schooler) %>% pull())*schooler +
                                                          (1+ 0.05)*(food_cost_general_adj_infl %>% select(toddler) %>% pull())*toddler +
                                                          (1+ 0.05)*(food_cost_general_adj_infl %>% select(infant) %>% pull())*infant,
                                                        hh_size == 4 ~
                                                          (1+ 0)*(food_cost_general_adj_infl %>% select(adult) %>% pull())*adult  +
                                                          (1+ 0)*(food_cost_general_adj_infl %>% select(teenager) %>% pull())*teenager +
                                                          (1+ 0)*(food_cost_general_adj_infl %>% select(preschooler) %>% pull())*preschooler +
                                                          (1+ 0)*(food_cost_general_adj_infl %>% select(schooler) %>% pull())*schooler +
                                                          (1+ 0)*(food_cost_general_adj_infl %>% select(toddler) %>% pull())*toddler +
                                                          (1+ 0)*(food_cost_general_adj_infl %>% select(infant) %>% pull())*infant,
                                                        hh_size == 5 ~
                                                          (1- 0.05)*(food_cost_general_adj_infl %>% select(adult) %>% pull())*adult  +
                                                          (1- 0.05)*(food_cost_general_adj_infl %>% select(teenager) %>% pull())*teenager +
                                                          (1- 0.05)*(food_cost_general_adj_infl %>% select(preschooler) %>% pull())*preschooler +
